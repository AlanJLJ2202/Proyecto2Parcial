...
public class frmProveedores extends javax.swing.JInternalFrame {
    ...
    private void bAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarActionPerformed
        nProveedores np = new nProveedores();
        np.setTitle("Nueva Sucursal");
        np.setModal(true);
        np.setVisible(true);
        tProveedores.setModel(new Proveedores().GetAllModel());
    ...
    private void bEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarActionPerformed
        if (tProveedores.getSelectedRow() >= 0) {
            int idSucursal = (int) tProveedores.getValueAt(tProveedores.getSelectedRow(), 0);
            Sucursales obj = new Sucursales();
            obj.setIdSucursal(idSucursal);
            obj.Delete();
            tProveedores.setModel(new Sucursales().GetAllModel());
        }else{
    ...
    private void bModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bModificarActionPerformed
        if(tProveedores.getSelectedRow()>= 0){
            int idProveedor = (int) tProveedores.getValueAt(tProveedores.getSelectedRow(), 0);
            nSucursales obj = new nSucursales(idProveedor);
